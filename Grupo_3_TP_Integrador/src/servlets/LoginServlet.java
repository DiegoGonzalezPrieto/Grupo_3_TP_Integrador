...
public class LoginServlet extends HttpServlet {
	...
	private Usuario validarUsuario(String user, String password, UsuarioNegocioImpl n)
			throws UsuarioNoEncontradoException, PasswordIncorrectaException {
	...
	void confirmarLogin(Usuario usuario, HttpServletRequest request) {
		...
		if (!usuario.esAdmin()) {
			ClienteNegocio negCliente = new ClienteNegocioImpl();
			int idCliente = negCliente.buscarPorIdUsuario(usuario.getId());
			Cliente cliente = negCliente.buscarPorId(idCliente);
