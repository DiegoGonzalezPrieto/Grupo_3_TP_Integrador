            ...
            <div class="card-body">
                ...
                <form id="filterForm" action="ACA VA EL SERVLEt" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label for="importeMax">Importe Máximo Solicitado</label>
                            <input type="number" id="importeMax" name="importeMax" class="form-control" placeholder="Max">
                        </div>
                    </div>
                    <div class="form-row">
			...
			<table id="tabla-prestamos" class="table table-striped table-bordered">
				...
				<tbody>
						<tr>
			                ...
			                <td><a href="PagoPrestamo.jsp?id=1" class="btn btn-success btn-sm" style="font-size: 0.8em; padding: 0.25rem 0.5rem;">Pagar</a></td>
			            </tr>
			            <tr>
			                <td>2</td>
			                <td>C.AHORRO</td>
