	...
	<div class="container mt-4">
		<div class="mt-4">
			<div class="card-header bg-success text-white">
				<h2 class="p-2">Agregar Nueva Cuenta</h2>
			</div>
			...
			<form action="AgregarCuentaServlet" method="post">
				...
				<div class="form-group">
					<label for="tipoCuenta">Tipo de Cuenta:</label> <select
						id="tipoCuenta" name="tipoCuenta" class="form-control" required>
				...
				<div class="form-group">
					<label for="numeroCuenta">Número de Cuenta:</label> <input
						...
						class="form-control" value="<%=nuevaCuenta%>" readonly>
				</div>
				<%
					}
				%>
				...
				<div class="form-group">
					<label for="cbu">CBU:</label> <input type="text" id="cbu"
						name="cbu" class="form-control" value="<%=nuevoCBU%>" readonly>
				</div>
				<%
					}
				%>
				<div class="form-group">
					<label for="saldo">Saldo Inicial:</label> <input type="number"
						id="saldo" name="saldo" class="form-control" value="10000"
						readonly> <small class="form-text text-muted">El
						saldo inicial es fijo de $10,000</small>
				</div>
				<div class="text-center mb-3">
					<a type="button" class="btn btn-outline-secondary me-2"
						href="AdministracionCuentasServlet">Cancelar</a>
