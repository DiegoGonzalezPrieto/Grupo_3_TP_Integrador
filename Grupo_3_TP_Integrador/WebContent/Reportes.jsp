                ...
                <tr>
                    ...
                    <td>
	                    <div class="btn-group btn-group-sm" role="group">
						    <a href="VerReporteServlet?id=1" class="btn btn-primary me-2 mb-2">
						        <i class="fas fa-eye"></i>
						    </a>
						    <a href="DescargarReporteServlet?id=1" class="btn btn-warning mb-2" 
	...
	<div class="container">        
        ...
        <form action="ProgramarReporteServlet" method="POST">
	        <div class="mb-3">
	            ...
	            <select id="tipoReporteProgramado" name="tipoReporteProgramado" class="form-select">
	                <option value="clientes">Reporte de Clientes</option>
	                <option value="cuentas">Reporte de Cuentas</option>
	                <option value="prestamos">Reporte de Préstamos</option>
	            </select>
				...
				<select id="diasSemana" name="diasSemana" class="form-select" required>
